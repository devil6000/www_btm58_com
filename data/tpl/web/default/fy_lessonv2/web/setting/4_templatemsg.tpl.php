			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<span class="help-block">用户支付成功后模版消息通知，选择编号TM00001(购买成功通知)</span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<span class="help-block">下级购买课程时，上级获得佣金提醒，选择编号OPENTM201812627(佣金提醒)</span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<span class="help-block">成功推荐下级加入时，给推荐上级提醒，选择编号OPENTM405761879(下级代理商加入提醒)</span>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<span class="help-block">用户下新订单后通知管理员，选择编号OPENTM206930158(订单通知)</span>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">优惠券到账通知</label>
					<div class="col-sm-9">
						<div class="input-group">
						...
						<span class="help-block">优惠券到达账户后通知用户，选择编号OPENTM405464954(到账通知)</span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<span class="help-block">管理员审核讲师申请结果通知讲师，选择编号OPENTM408894858(审核结果通知
)</span>
					</div>
				</div>
			</div>
