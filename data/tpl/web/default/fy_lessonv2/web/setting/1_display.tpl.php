			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<span class="help-block">该项仅在微信客户端中生效，未关注公众号的用户访问时，“顶部引导关注”为顶部引导关注；<strong>“顶部和课程页关注”为顶部引导关注和课程详情页强制关注，该方式请在“系统管理—公众号应用—订阅管理”里开启微课堂V2的订阅器</strong></span>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">课程页关注标题</label>
					<div class="col-sm-9">
						<input type="text" name="lesson_follow_title" value="<?php  echo $setting['lesson_follow_title'];?>" class="form-control" />
						<span class="help-block">课程页强制关注公众号标题，默认为“长按指纹识别二维码，关注公众号”</span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">课程页关注描述</label>
					<div class="col-sm-9">
						<input type="text" name="lesson_follow_desc" value="<?php  echo $setting['lesson_follow_desc'];?>" class="form-control" />
						<span class="help-block">课程页强制关注公众号标题，默认为“关注后继续学习，可接收最新课程通知”</span>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">讲师申请</label>
					<div class="col-sm-9">
						<label class="radio-inline"><input type="radio" name="teacher_income" value="1" <?php  if($setting['teacher_income']==1) { ?>checked<?php  } ?> /> 开启</label> &nbsp;
						<label class="radio-inline"><input type="radio" name="teacher_income" value="0" <?php  if($setting['teacher_income']==0) { ?>checked<?php  } ?> /> 关闭</label>
						<span class="help-block"><strong></strong>关闭后，个人中心将不显示“讲师中心”，已申请讲师通过的讲师不受影响</span>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">个人中心设置按钮</label>
					<div class="col-sm-9">
						<label class="radio-inline"><input type="radio" name="self_setting" value="1" <?php  if($setting['self_setting']==1) { ?>checked<?php  } ?> /> 显示</label> &nbsp;
						<label class="radio-inline"><input type="radio" name="self_setting" value="0" <?php  if($setting['self_setting']==0) { ?>checked<?php  } ?> /> 隐藏</label>
						<span class="help-block"><strong></strong>开启后，手机端个人中心将显示“设置”按钮</span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">绑定手机号码</label>
					<div class="col-sm-9">
						<label class="radio-inline"><input type="radio" name="modify_mobile" value="2" <?php  if($setting['modify_mobile']==2) { ?>checked<?php  } ?> /> 个人中心和首页验证</label> &nbsp;
						<label class="radio-inline"><input type="radio" name="modify_mobile" value="1" <?php  if($setting['modify_mobile']==1) { ?>checked<?php  } ?> /> 个人中心验证</label> &nbsp;
						<label class="radio-inline"><input type="radio" name="modify_mobile" value="0" <?php  if($setting['modify_mobile']==0) { ?>checked<?php  } ?> /> 关闭</label>
						<span class="help-block"><strong></strong>开启个人中心验证后，手机端个人中心将显示“绑定手机”按钮；开启个人中心和首页验证后，同时进入首页时，未绑定手机号码用户将提示绑定手机号码；该选项需要使用阿里短信验证</span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<span class="help-block">开启首页验证绑定手机号码时，需同时设置的选项；开启强制验证手机后，将不会显示关闭验证手机的对话框</span>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group item">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">会员课程足迹</label>
					<div class="col-sm-4">
						<select name="clearhistory" class="form-control">
							<option value="0">不进行任何操作</option>
							<option value="1">清空会员课程足迹</option>
						</select>
					</div>
				</div>
				<div class="form-group">
