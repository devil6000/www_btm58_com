...
<ul class="nav nav-tabs">
    ...
    <li <?php  if($op=='commission' && $_GPC['status']==0) { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('finance', array('op'=>'commission'));?>">提现申请</a></li>
			...
			<div class="form-group">
				...
				<div class="col-sm-2 col-lg-3">
					<select name='status' class='form-control'>
						<option value="">全部</option>
						<option value="0" <?php  if(in_array($_GPC['status'], array('0'))) { ?>selected<?php  } ?>>待打款</option>
						<option value="1" <?php  if($_GPC['status']==1) { ?>selected<?php  } ?>>已打款</option>
						<option value="-1" <?php  if($_GPC['status']==-1) { ?>selected<?php  } ?>>无效申请</option>
					</select> 
				</div>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<p class="form-control-static"><img src='<?php  echo $cashlog['avatar'];?>' style='width:30px;height:30px;padding1px;border:1px solid #ccc' /> <?php  echo $cashlog['nickname'];?>(<?php  echo $cashlog['realname'];?>)</p>
					</div>
				</div>
				<div class="form-group">
