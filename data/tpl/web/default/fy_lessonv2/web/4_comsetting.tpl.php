            ...
            <div class="panel-body">
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
						...
						&nbsp;
						<label class="radio-inline"><input name="hidden_sale" type="checkbox" value="1" <?php  if($comsetting['hidden_sale']) { ?>checked<?php  } ?>> 提交小程序审核</label>
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline"><input type="radio" name="cash_type" value="1" id="cashtype1" <?php  if(empty($comsetting) || $comsetting['cash_type'] == 1) { ?>checked="true"<?php  } ?> /> 管理员审核</label>
                        &nbsp;
				...
				<div class="form-group item">
					...
					<div class="col-sm-4">
						<select name="level" class="form-control" onchange="checklevel(this.value);">
							...
							<option value="3" <?php  if($comsetting['level']==3) { ?>selected<?php  } ?>>三级分销</option>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							...
							<input type="text" name="font[commission_cash]" value="<?php  echo $font['commission_cash'];?>" class="form-control" placeholder="位置：个人中心—分销中心—佣金提现">
						</div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							...
							<input type="text" name="font[commossion_cash_log]" value="<?php  echo $font['commossion_cash_log'];?>" class="form-control" placeholder="位置：个人中心—分销中心—佣金提现明细">
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							...
							<input type="text" name="font[commossion_award]" value="<?php  echo $font['commossion_award'];?>" class="form-control" placeholder="位置：个人中心—分销中心—佣金提现明细">
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							...
							<input type="text" name="font[his_commission]" value="<?php  echo $font['his_commission'];?>" class="form-control" placeholder="位置：个人中心—我的团队">
						</div>
					</div>
				</div>
			</div>
