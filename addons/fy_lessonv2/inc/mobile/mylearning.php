...
//$mylearninglist = pdo_fetchall('SELECT a.*,b.images,b.difficulty,b.virtual_buynum FROM ' . tablename($this->table_mystudy) . ' a LEFT JOIN ' . tablename($this->table_lesson_parent) . ' b ON a.lessonid=b.id WHERE {$condition} ORDER BY a.id DESC LIMIT ' . ($pindex - 1) * $psize . ',' . $psize, $params);
