...
$member = pdo_fetch("SELECT mobile,realname,msn,occupation,company,graduateschool,grade,salt FROM " .tablename($this->table_mc_members). " WHERE uid=:uid", array(':uid'=>$uid));
