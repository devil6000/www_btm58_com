...
FileProgress.prototype.setComplete = function(up, info) {
    ...
    var showImg = $('<img src="../addons/fy_lessonv2/template/mobile/images/loading.gif"/>');

    progressNameTd.append(Wrapper);

    if (!isImg) {
        showImg.attr('src', '../addons/fy_lessonv2/template/mobile/images/media.jpg');
        ...
        $(img).on('load', function() {
            ...
            showImg.attr('src', '../addons/fy_lessonv2/template/mobile/images/pictrue.jpg');
            Wrapper.addClass('default');
        });
    }
};
