...
include_once dirname(__FILE__).'/inc/common/TypeStatus.php';
...
/***************************** Mobile方法 ******************************** */
	...
	/* 课程习题 */
	public function doMobilePraxis(){
	    $this->__mobile(__FUNCTION__);
    }
...
/************************************************ 公共方法 ************************************ */
    ...
    public function updatelessonmember() {
		...
		if(empty($recid)){
			$member_recommend = pdo_get($this->table_member_recommend, array('uniacid'=>$_W['uniacid'],'unionid'=>$_W['fans']['unionid']));
			
			$recid = $member_recommend['parentid'];
			if($recid){
				pdo_delete($this->table_member_recommend, array('recommend_id'=>$member_recommend['recommend_id']));
			}
		}
